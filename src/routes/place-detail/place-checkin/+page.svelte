<script lang="ts">
	...
	let time = '2023-01-01';
	let content = 'The menu at Savor Delights is a testament to the chef\'s creativity and commitment to using fresh, high-quality ingredients.';
	let rating = 4;
...
<div class="flex flex-col space-y-8 py-8">
	{#each { length: 5 } as _, i}
		<Review {userSrc} {userFullName} {time} {content} {rating} />
	{/each}
</div>